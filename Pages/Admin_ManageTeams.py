...
class ManageTeams():
    ...
    def select_modules(self):
        ...
        getnames = self.driver.find_elements(By.NAME, self.OTHERCHECKBOXES)  # Getting class NAME which is associated with all checkboxes
        #print(getnames)
        getnames[16].click() # Click on class NAME+20th indexing checkbox
        time.sleep(2)
        getnames[20].click() # Click on class NAME+32nd indexing checkbox
        time.sleep(2)
