...
class AdminAddUsers():
    ...
    def verify_user(self):
        un = self.driver.find_element(By.XPATH,self.MBAPPEXPATH)
        if un.text == "Kylian Mbappe":
    ...
    def hoverleftnavmenu(self):
        element = WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((By.XPATH,self.LEFTSIDENAVMENU)))
