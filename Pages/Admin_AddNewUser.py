...
#         self.driver.find_element(By.XPATH,self.TEAMSDD)
#
#     def enter_team_name(self, Teamname):
#         self.input_element(self.TEAMSTYPEAREA, Teamname)
#         time.sleep(2)
#         self.driver.find_element(By.XPATH,self.SELECTEDTEAMCHECKBOX)
#
...
#         usdd = self.driver.find_elements self.USERSTATUSEDD)
#         var = usdd[0]
#         var.click()
#         time.sleep(1)
