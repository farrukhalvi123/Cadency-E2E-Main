...
def launch_browser(context,scenario):
    if TestData.BROWSER == 'chrome':
        ...
        prefs = {
            ...
            "download.default_directory": os.getcwd() + '\\TestData\\TestExcelsandPDFS\\',
        ...
        if TestData.PLATFORM == 'Browser Stack':
            ...
            context.driver = webdriver.Chrome(options=options, executable_path= r"C:\Users\Datasoft\PycharmProjects\Cadency-E2E-Main\chromedriver-win64\chromedriver.exe")
